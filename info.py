...
# Bot information
API_ID = environ.get('API_ID', '22119300')
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '7008a6b3605a7ca6a923a6622b5f1832')
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6853195458:AAHpIbMLA6i2MUdyae8qzL5nSaUx_9lEbqY')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '1270325350')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '1002037593743')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '1001713833919')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Kunjumon:OIzyqnEsnodg3PDs@kunjupanic.dnd9mag.mongodb.net/?retryWrites=true&w=majority")
if len(DATABASE_URL) == 0:
    print('Error - DATABASE_URL is missing, exiting now')
    exit()
DATABASE_NAME = environ.get('DATABASE_NAME', "kunjoos")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "1002005122148")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://t.me/+2E1ItRTTjpc5MTY9")
if len(URL) == 0:
